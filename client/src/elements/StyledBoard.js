...
export const StyledBoard = styled.div`
    border: ${props => props.isToggled !== true ?  '1px solid #88d70a' : '3px solid #fea42a'};
    background-color: ${props => props.isToggled !== true ?  '#40a700' : '#88D70A'};
    color: ${props => props.isToggled !== true ?  '#88D70A' : 'black'};
    text-shadow: ${props => props.isToggled !== true ?  '1px 1px black' : 'none'};
